...
// Add a dark basemap tile layer (CartoDB Dark Matter style).
// {{s}} = subdomain (a/b/c/d), {{z}}/{{x}}/{{y}} = zoom/tile coordinates, {{r}} = retina suffix
